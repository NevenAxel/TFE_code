...
module.exports="/dist/cec1818a6b55d17700add1d92d83fa76.svg";
},{}],30:[function(require,module,exports) {
module.exports="/dist/2114094178f78944248bc44d0741773f.svg";
...
},{"./utils":15,"./img/actions/sword.svg":26,"./img/actions/bow.svg":28,"./img/actions/swipeleft.svg":29,"./img/actions/swiperight.svg":30}],46:[function(require,module,exports) {
...
module.exports="/dist/9c769ae46447153719588827db60fe33.svg";
},{}],48:[function(require,module,exports) {
module.exports="/dist/3dc385e798ff9a1d2128555b3972832b.svg";
...
var _potionhp = require('../img/loot/potionhp.svg');

var _potionhp2 = _interopRequireDefault(_potionhp);
	...
	return {
		...
		action: function action() {
			if (player.getIntel() >= 5) {
				...
				if (Math.random() < 0.7) {
					(0, _game.feedbackMessage)(player, "Vous n'êtes pas assez intelligent pour porter l'haltère, vous vous êtes blaissé");
					player.setHp(player.getHp() - 5, player);
				} else {
					player.setStr(player.getStr() + 5);
				}
...
},{"../utils":15,"../game":19,"../img/loot/potionhp.svg":46,"../img/loot/coinsbag.svg":45,"../img/loot/dumbbell.svg":47,"../img/loot/magicbook.svg":48}],54:[function(require,module,exports) {
...
module.exports="/dist/f56dcb6f1a1eeba90aee15ce72ca2b87.svg";
...
function generateGiveCoins(player, swipeActions) {
	return {
		name: "givecoins",
		coinsGiven: (0, _utils.getRandomNumber)(1, 3),
		text: function text() {
		...
		action: function action() {
			if (player.getCoin() - this.coinsGiven < 0) {
				...
				player.thisRoom.nextRoom = {
					...
					swipeLeft: {
						coinsGiven2: (0, _utils.getRandomNumber)(2, 5),
						text: function text() {
		...
		action: function action() {
			if (player.getAgility() >= this.require) {
				if (Math.random() < 0.3 * 5 / player.getAgility()) {
					(0, _game.feedbackMessage)(player, 'Pas de chance, vous avez trébuché sur une pierre');
					player.setHp(player.getHp() - this.damage, player);
				} else {
...
},{"../utils":15,"../game":19,"../img/actions/feed.svg":54,"../img/actions/escape.svg":52,"../img/actions/givecoins.svg":53,"../img/loot/coinsbag.svg":45,"../img/actions/scream.svg":55}],41:[function(require,module,exports) {
'use strict';
...
},{"../utils":15,"../game":19,"../img/actions/sword.svg":26,"../img/actions/bow.svg":28}],56:[function(require,module,exports) {
...
},{"../utils":15,"../game":19,"../img/actions/eat.svg":56,"../img/actions/no.svg":57}],43:[function(require,module,exports) {
'use strict';
				...
				swipeLeft: {
					...
					action: function action() {
						if (img == frogregular_svg) {
							...
							(0, _game.feedbackMessage)(player, "Le crapaud vous a sauté dans la bouche, beurk!");
...
},{"../utils":15,"../game":19,"../img/actions/feed.svg":54,"../img/actions/escape.svg":52}],18:[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  frog: [{ name: 'eatFrog', rarity: 0 }, { name: 'kissFrog', rarity: 0 }, { name: 'talkFrog', rarity: 10 }, { name: 'feedFrog', rarity: 10 }, { name: 'killFrog', rarity: 10 }],
...
},{"./utils":15,"./game":19,"./actions/actionsLoots":39,"./actions/actionsMonsters":40,"./actions/actionsStarting":41,"./actions/actionsMushroom":42,"./actions/actionsFrog":43}],9:[function(require,module,exports) {
...
module.exports="/dist/3ce27ece29cf3fcc92164ac78d482896.svg";
},{}],50:[function(require,module,exports) {
module.exports="/dist/789eb9e01c86182b716b6674d8eda08b.svg";
...
},{"../utils":15,"../game":19,"../img/monsters/goblin.svg":9,"../img/monsters/spider.svg":49,"../img/monsters/frog-regular.svg":51,"../img/monsters/frog-toxic.svg":50}],31:[function(require,module,exports) {
...
},{"../utils":15,"../game":19,"../img/monsters/mushroom-a1.svg":31,"../img/monsters/mushroom-a2.svg":32,"../img/monsters/mushroom-b1.svg":33,"../img/monsters/mushroom-b2.svg":34,"../img/monsters/mushroom-c1.svg":35,"../img/monsters/mushroom-c2.svg":36}],37:[function(require,module,exports) {
module.exports="/dist/768808c21db4ca73d1532d7fb88c6449.svg";
...
},{"../utils":15,"../game":19,"../img/monsters/forgeron.svg":37}],23:[function(require,module,exports) {
'use strict';
...
},{"../utils":15,"../game":19}],38:[function(require,module,exports) {
...
var _chest = require('../img/monsters/chest.svg');
...
},{"../utils":15,"../game":19,"../img/monsters/chest.svg":38}],17:[function(require,module,exports) {
'use strict';
...
exports.default = {
    forestMonsterList: [{ name: 'wolf', rarity: 0 }, { name: 'rogue', rarity: 2 }, { name: 'gobelin', rarity: 3 }, { name: 'spider', rarity: 0 }, { name: 'shroom', rarity: 5 }, { name: 'frog', rarity: 50 }],
...
},{"./utils":15,"./swipeActions":18,"./rooms/forestMonster":25,"./rooms/forestLoot":21,"./rooms/startingroom":22,"./rooms/monsters":23,"./rooms/chest":24}],16:[function(require,module,exports) {
'use strict';
...
},{"./utils":15,"./game":19,"./img/actions/sword.svg":26}],3:[function(require,module,exports) {
'use strict';
...
},{"./room":17,"./player":16,"./swipeActions":18,"./utils":15,"./game":19}],58:[function(require,module,exports) {
