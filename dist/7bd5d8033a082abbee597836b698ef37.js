...
function generateSleepMushroom(player, swipeActions) {
	return {
		...
		action: function action() {
			...
			player.setHp(player.getStr() - 3, player);
		}
	};
}
...
function generateStupidMushroom(player, swipeActions) {
	return {
		...
		action: function action() {
			...
			player.setHp(player.getIntel() - 3, player);
		}
	};
}
...
function generateAgilityMushroom(player, swipeActions) {
	return {
		...
		action: function action() {
			...
			player.setHp(player.getAgility() + 3, player);
		}
	};
}
...
function generateYummyMushroom(player, swipeActions) {
	return {
		...
		action: function action() {
			...
			player.setHp(player.getHp() + 8, player);
		}
	};
}
...
exports.default = {
    forestMonsterList: [{ name: 'wolf', rarity: 0 }, { name: 'rogue', rarity: 2 }, { name: 'gobelin', rarity: 3 }, { name: 'spider', rarity: 5 }, { name: 'shroom', rarity: 0 }],
